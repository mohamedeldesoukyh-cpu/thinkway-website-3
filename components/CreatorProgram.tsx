...
export default function CreatorProgram() {
  ...
  return (
    <section id="program" ref={ref} className="section-padding bg-[#f8f8f8] relative overflow-hidden">
      ...
      <div className="container-custom">
        ...
        >
          ...
          <div className="max-w-sm">
            ...
            <div className="flex gap-6">
              {[["6", "Modules"], ["19", "Total Weeks"], ["Live", "Sessions"]].map(([val, label]) => (
                <div key={label}>
                  <div className="text-xl font-bold text-[#0a0a0a]">{val}</div>
                  <div className="text-[9px] tracking-[0.2em] text-[#ccc] uppercase mt-1">{label}</div>
                </div>
              ))}
            </div>
          </div>
            ...
            >
              ...
              >
                ...
                <div className="flex items-center gap-6 shrink-0">
                  <span className="hidden md:block text-[9px] tracking-[0.15em] text-[#ccc] uppercase">{mod.duration}</span>
                  <span className="hidden md:block text-[9px] tracking-[0.15em] text-[#ccc] uppercase">{mod.level}</span>
                  <motion.div
              ...
              >
                <div className="pb-8 pl-12 pr-4">
                  <p className="text-[10px] text-[#aaa] tracking-[0.1em] leading-[2.4] max-w-2xl">{mod.desc}</p>
                </div>
              </motion.div>
            </motion.div>
          ))}
        ...
        >
          <div>
            <div className="text-sm font-semibold tracking-[0.12em] uppercase text-[#0a0a0a]">Ready to grow?</div>
            <div className="text-[10px] text-[#bbb] tracking-widest uppercase mt-1">Limited spots available per cohort.</div>
          </div>
